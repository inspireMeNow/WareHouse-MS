    ...
    <el-card>
      ...
      <el-table ref="filterTable" :data="tableData" style="width: 100%">
        <el-table-column
          ...
          width="80"
        ></el-table-column>
        <el-table-column prop="ocode" label="订单编号" align="center">
        </el-table-column>
        <el-table-column prop="pcode" label="产品编号" align="center">
        </el-table-column>
        <el-table-column prop="num" label="数量" align="center">
        </el-table-column>
        <el-table-column prop="otime" label="出库时间" align="center" :formatter="dateFormat">
        </el-table-column>
...
name:'OutOrderManager',
  ...
  methods: {
    ...
    getDatalist() {
      ...
      //获取数据
      this.$http.get("/getOutOrder", params).then((res) => {
        // console.log(res);
